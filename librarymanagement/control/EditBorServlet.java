...
/**
 * Servlet implementation class EditBorServlet
 */
@WebServlet("/html/editBorrow")
public class EditBorServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EditBorServlet() {
        super();
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		bor.setBorrow_id(Integer.parseInt(request.getParameter("Borrow_id")));
