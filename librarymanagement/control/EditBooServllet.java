...
/**
 * Servlet implementation class EditBooServllet
 */
@WebServlet("/html/editB")
public class EditBooServllet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EditBooServllet() {
        super();
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//1.封装数据
		Book boo=new Book();
		boo.setBook_id(Integer.parseInt(request.getParameter("book_id")));
